...
const validationSchema = Yup.object().shape({
  password: Yup.string()
    .min(2, 'Le mot de passe doit être composé de 2 caractères')
    .required('Le mot de passe est obligatoire !'),
  email: Yup.string().email('Adresse électronique invalide').required('Ladresse électronique est obligatoire !'),
});
                ...
                <form onSubmit={handleSubmit} >
                  ...
                  <FlexBox justifyContent="space-between">
                    <FlexBox gap={1}>
                      ...
                      <Paragraph>Souvenez-vous de moi</Paragraph>
                    </FlexBox>

                    <NavLink
                      to="/fr/session/forgot-password"
                      style={{ color: "#25D1F6" }}
                    >
                      Mot de passe oublié ?
                    </NavLink>
